...
"></span>
					...
					<div class="el-callout">
						...
						<div class="title"><a href="<?php echo esc_url( get_permalink( $el_post_object->ID ) ); ?>"><?php echo get_the_title( $el_post_object->ID ); ?></a></div>
					</div>
				</div>
			</div>
			<?php endif; ?>
...
"></span>
					...
					<div class="ert-callout">
						...
						<div class="title"><a href="<?php echo esc_url( get_permalink( $ert_post_object->ID ) ); ?>"><?php echo get_the_title( $ert_post_object->ID ); ?></a></div>
					</div>
				</div>
			</div>
			<?php endif; ?>
...
"></span>
					...
					<div class="erb-callout">
						...
						<div class="title"><a href="<?php echo esc_url( get_permalink( $erb_post_object->ID ) ); ?>"><?php echo get_the_title( $erb_post_object->ID ); ?></a></div>
					</div>
				</div>
			</div>
			<?php endif; ?>
